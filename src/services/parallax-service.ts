...
export class ParallaxService implements IService {
	...
	getDataForTheme = (menuItem: any): any => {
		return this["getDataFor" + menuItem.theme.charAt(0).toUpperCase() + menuItem.theme.slice(1)]();
	};
	...
	getDataForLayout4 = (): any => {
		return {
			...
			title:
				"Infinit bridge made in China. Locals said that is not possible to see end of bridge. 7 people lost during walk.",
			...
			items: [
				...
				},
				{
					...
					subtitle:
						"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry ut labore et dolore magna aliqua. Ut enim ad minim veniam."
				}
			]
		};
	};
